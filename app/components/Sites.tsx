...
const Sites = () => {
  ...
  const relatedItems = [
    ...
    {
      label: "ST. PATRICK’S - WITHNEY PT",
      href: "/components/churches/patrick",
    },
    ...
    <>
      <div className="hidden lg:flex justify-center">
        <div className="absolute top-0 lg:top-[46vw] z-20">
          <button className="text-[#003629] bg-white font-bold px-6 py-3 lg:py-1 rounded-xl relative left-80">
            Related Sites
          </button>
      ...
      <div className="flex lg:hidden justify-center text-center mx-3">
        <div className="">
          <button className=" font-bold px-6 py-3 lg:py-1 rounded-xl text-2xl text-[#003629]">
            Related Sites
          </button>
