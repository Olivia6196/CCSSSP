...
import { MdOutlineLibraryMusic, MdOutlineRecordVoiceOver } from "react-icons/md";
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 ">
        <div className="flex flex-col lg:flex-row gap-13">
          <div className=" md:border border-gray-300 py-8 md:pt-10 md:px-10 lg:h-135 rounded-xl">
            ...
            <p className=" pb-6 lg:w-[50vw] leading-8 text-xl font-medium text-black/55">
              From our youngest disciples to those seeking to enter the Church,
              we offer comprehensive programs that nourish the mind and spirit
            ...
            <div className="bg-[#003629] text-white/70 mb-16 lg:mb-0 p-8 lg:p-9 lg:pt-16 rounded-lg lg:rounded-t-2xl lg:rounded-br-sm lg:h-[43vw] lg:w-[27vw]">
              ...
              <div className="space-y-4">
                {outreachItems.map((item) => (
                  <div key={item.title} className="flex items-start gap-4 border-b border-white/20 pb-3">
        ...
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-[#003629] text-center mb-16">
            Liturgi<span className="border-b-3 border-[#CBA72F] pb-1">cal M</span>inistries
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {liturgicalMinistries.map((ministry) => (
              ...
              >
                ...
                <h3 className="font-semibold text-lg mb-1">{ministry.title}</h3>
