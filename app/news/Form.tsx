        ...
        <form onSubmit={handleSubmit} className="space-y-6 overflow-x-hidden">
          ...
          <div>
            ...
            <input
              ...
              className="w-full md:w-[38vw] md:h-16 px-4 py-3 bg-zinc-5 border border-gray-400  rounded-xl focus:outline-none focus:ring-2 focus:ring-[#003629] focus:border-transparent transition-all duration-200 disabled:opacity-70"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              disabled={isSubmitting}
              className="w-full md:w-[38vw] md:h-16 px-4 py-3 border border-gray-400 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#003629] focus:border-transparent transition-all duration-200 disabled:opacity-70"
            />
          </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              disabled={isSubmitting}
              className="w-full md:w-[38vw] md:h-16 px-4 py-3  border border-gray-400 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#003629] focus:border-transparent transition-all duration-200 disabled:opacity-70 resize-none overflow-hidden"
            />
          </div>
          </div>
