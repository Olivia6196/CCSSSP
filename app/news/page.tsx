...
const NewsPage = async ({ searchParams }: { searchParams: Props }) => {
  ...
  return (
    <>
      ...
      <Sites />
      <main className="m-auto lg:max-w-4xl">
        <h1 className="mt-10 lg-mt-0 text-3xl font-bold mb-6 text-center">News & Events</h1>
        ...
        <div className="space-y-8 ">
          {paginatedPosts.map((post) => {
            ...
            return (
              <article key={post.id}>
                <div className="flex justify-center flex-col md:flex-row mx-4 md:items-center gap-6">
                  <div className="flex flex-col justify-center items-center w-[19vw] md:w-[9vw] lg:w-[5vw] mt-2 bg-[#003629] border border-gray-300 rounded-full pt-3.5">
                ...
                <div
                  className="mt-1 text-lg leading-8 overflow-hidden md:text-center mx-4 md:mx-10"
        ...
        {/* PAGINATION */}
        <div className="flex justify-between mt-16 border-t border-[#bbbab6] mx-4 py-6">
          {/* PREVIOUS */}
          {hasPrev ? (
            <Link
          ...
          {/* PAGE INFO */}
          <p className="text-[#003629] font-medium text-sm md:text-base">
